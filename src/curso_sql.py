def curso_sql(total_aulas, aulas_concluidas, nome, dias_decorridos):
    """
    ...
    print(f"\nOlá, {nome}!")
    print("Acompanhe abaixo o seu progresso no curso de SQL.")
    print("OBS: A meta é finalizar o curso até o fim de Fevereiro.\n")
    ...
    dias_ja_planejados = 0  # dias já considerados no planejamento
